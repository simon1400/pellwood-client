        ...
        <div className="login_form">
          <form onSubmit={(e) => handleFilter(e)}>
            ...
            <div className="search_wrap">
              ...
              <label><input className="effect-9 search_input" type="text" placeholder="Hledat..." value={search} onChange={e => setSearch(e.target.value)} /></label>
              {!!search.length && <img src={times} onClick={() => setSearch('')} alt="clear" />}
            </div>

            <div className="range-wrap">
              <div className="range-info">
                <span className="name-range">delka palicek</span>
            ...
            <div className="range-wrap">
              <div className="range-info">
                <span className="name-range">prumer palicek</span>
            ...
            <button type="submit" className="tm-button tm-black-button uk-width-1-1">Zobrazit vysledky</button>
